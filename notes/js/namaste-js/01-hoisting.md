...
- Executes code line by line, using the allocated memory from the ^first phase 
...
- Variables: Partially hoisted, declared but initialized as `undefined`
  Same with function expression & arrow function expression
