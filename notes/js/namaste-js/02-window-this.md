# 5
Global Object
![](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/DOM_scripting/document-window-navigator.png)
- "window" in browser
- "global" in node.js
...
inner functions: "this" won’t refer to the global object unless explicitly set
