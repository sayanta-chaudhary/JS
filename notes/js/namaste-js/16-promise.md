...
- Creator/Producer & Consumer

Callbacks vs Promises? - Aren't promises just callbacks?
Why there is pending state in Promise?
...
- A promise resolves only once and it's immutable
...
Create a promise, and resolve it when a button is clicked
