...
why we use forms in the first place?
to give options, when you see the options of choosing something behind the scean it'a always form
...
AJAX (Asynchronous JavaScript and XML) - updates parts of a webpage without reloading the whole page
enctype # required for file uploads - multipart/form-data: splits data parts, suitable for binary data
